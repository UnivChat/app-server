...
//                    .lastMessageId(null)
    ...
    public static class ClassChatReq extends ChatReq {
        ...
        public ClassChat toEntity(Optional<ClassChatRoom> classRoom,Optional<Member> member, String messageSendingTime) throws Exception {
